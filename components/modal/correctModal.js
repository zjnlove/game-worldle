...
function CorrectModal(props) {
	...
	return (
		<Modal show={showModalState}>
			<div className="bg-white rounded-2xl border-2 border-[--ghibli-soft-green] shadow-xl overflow-hidden">
				<div className="relative">
					<IoCloseOutline
						className="absolute right-4 top-4 text-2xl text-gray-500 hover:text-[--ghibli-dark] cursor-pointer z-10"
